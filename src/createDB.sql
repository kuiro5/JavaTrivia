...
(                         
    player_name varchar(40) not null,                                    /* full name of the building       */
    player_score smallint,                                   /* short name of the building  */    
    constraint pk_high_scores primary key (player_name)
);
...
INSERT INTO QUESTION_BANK (QUESTION_NUMBER, TEXT, ANSWER_A, ANSWER_B, ANSWER_C, ANSWER_D, CORRECT_ANSWER, DIFFICULTY) 
VALUES (8, 'In what year did the programming language C++ first appear', '1972', '1983', '1994', '1964', 1, 8);
